...
namespace DemoPE.Web.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(BookPublisherContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await bookPublisherContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("BookId,BookName,Quantity,AuthorName,PublisherId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("BookId,BookName,Quantity,AuthorName,PublisherId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
